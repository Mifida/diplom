...
<head>
    <meta charset="UTF-8">
    <title>Stadydara Калькулятор</title>
                            ...
                            <div class="isi2">
                                ...
                                <div id="form-IP">
                                    ...
                                    <div id="range">
                                        ...
                                        <div id="slider-Per" title="Количество единиц в маске"></div>
                                    </div>
                    ...
                    <div class="sisi hasil addMargin">
                        <div id="konten">
                            <div class="isi">
                                ...
                                <div id="tag">
                                    <div id="judul" class="hasilJudul" title="Особый адрес для каждой сети, который осуществляет связь для всех узлов, расположенных в этой сети.">
                                ...
                                <div id="tag">
                                    <div id="judul" class="hasilJudul" title="Используется для определения к какой подсети принадлежит введенный IP">
                                        Маска подсети
                                    </div>
