    ...
    <div class="wrapper">
        ...
        <div class="content">
            <div class="text">
                ...
                <p>Страница "Профиль" видна только преподавателям и администраторам сайта. Здесь пользователь может загрузить материалы лекций на обработку. Справа от кнопки загрузки есть таблица, в которой преподаватель может отслеживать отправленные файлы и статус их обработки (рис. №6). Ниже находятся две таблицы, с помощью которых преподаватель и администратор могут отслеживать статистику посещаемости страниц с лекциями и тестами (рис. №7).</p>
                <p class="image">
                    <img src="../images/dddd.PNG" alt="6" height="400px"><br>
                    <span>рис. №6</span>
                </p>
                <p class="image">
                    <img src="../images/cccc.PNG" alt="7" height="400px"><br>
                    <span>рис. №7</span>
                </p>
            </div>
<footer>
